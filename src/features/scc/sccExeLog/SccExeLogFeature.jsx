...
import styles             from './SccExeLogFeature.module.css'
 ...
 */
export default function SccExeLogFeature() {
    ...
    const colDefs = useMemo(() => [
        {
            field:'id', headerName:'SCC 산출 ID', width:160, flex:0,
